...
if __name__ == "__main__":
    ...
    results = (yolo_result, ultraface_result, ssdface_result, retinaface_result, retinaface_dnn_result,
               facebox_result, facebox_dnn_result, dbface_result, centerface_result, lffdface_result, libface_result)
    waste_times = (
    yolo_time, ultraface_time, ssdface_time, retinaface_time, retinaface_dnn_time, facebox_time,
    facebox_dnn_time, dbface_time, centerface_time, lffdface_time, libface_time)

    line1 = np.hstack(results[:4])
    #line2 = np.hstack(results[4:7])
    #line3 = np.hstack(results[7:])
